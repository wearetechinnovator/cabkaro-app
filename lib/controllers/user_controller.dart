...
class UserController extends ChangeNotifier {
  ...
  // Gender selection — shared by UserDetailsScreen and anywhere else needed
  ...
  Future<void> signup(BuildContext ctx) async {
    ...
    try {
      ...
      Map<String, dynamic> data = {
        ...
        "gender": selectedGender, // ← uses selected value instead of hardcoded
        "profile_img": userProfileBase64,
        "token": token,
      };

      if (profileImage != null) {
        final base64Image = await ImagePickerService.fileToBase64(profileImage!);
  ...
  Future<void> getUserDetails(BuildContext ctx) async {
    try {
      ...
      if (req.statusCode != 200) {
        ...
        // Sync gender from API if available
