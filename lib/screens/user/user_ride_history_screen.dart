...
class UserRideHistoryScreen extends StatelessWidget {
  ...
  double get _totalEarnings => _dummyRides.fold(0, (sum, r) => sum + r.fare);
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) =>
                        _RideTile(ride: _dummyRides[index]),
                  ),
                ),
              ],
            ),
  ...
  String get _avgRating {
    final avg =
        _dummyRides.fold(0, (sum, r) => sum + r.rating) / _dummyRides.length;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Route
            _RouteRow(pickup: ride.pickupAddress, drop: ride.dropAddress),
            ...
            Row(
              children: [
                _Chip(icon: Icons.timer_outlined, label: ride.duration),
      ...
      children: [
        Column(
          children: [
            ...
            Container(width: 1.5, height: 24, color: const Color(0xFFCCCCCC)),
            Container(
              width: 10,
              height: 10,
              decoration: BoxDecoration(
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                pickup,
                style: const TextStyle(fontSize: 13, color: Color(0xFF2D2F35)),
              ),
