      ...
      body: SafeArea(
        child: Stack(
          ...
          children: [
                          ...
                          child: TextField(
                            ...
                            onChanged: (v) {
                              ...
                              _debounce = Timer(
                                const Duration(
                                  milliseconds: 500,
                                ), // Slightly longer debounce so we don't spam free API
                                () => _fetchSuggestions(v),
                              );
                            },
                            onTap: () {
            ...
            Positioned(
              bottom: 30,
              left: _isResolving ? 170: 60,
              right: _isResolving ? 170: 60,
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  shape: RoundedRectangleBorder(
                    borderRadius:  _isResolving ? BorderRadius.circular(30) : BorderRadius.circular(12),
                  ),
                ),
                child: _isResolving
                    ? const SizedBox(
