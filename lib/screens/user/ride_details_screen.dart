          ...
          children: [
            ...
            Padding(
              ...
              child: Wrap(
                ...
                runSpacing: 7.0,
                children: [
                  _FarePill(fare: "${widget.rideData['seater']} Seater"),
                  _FarePill(fare: widget.rideData['ac_type']),
                  _FarePill(fare: widget.rideData['sos']),
                  _FarePill(fare: widget.rideData['first_aid']),
                ],
              ),
            ),
            ...
            // ------------------- [Other Facilities] --------------
            Padding(
              padding: const EdgeInsets.only(left: 16, bottom: 5.0, top: 5.0),
              child: Text(
                "Other Facilities",
                style: GoogleFonts.poppins(
                  fontSize: 13.0,
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Expanded(
                    child: Text(
                      widget.rideData['other_facilities'],
                      overflow: TextOverflow.clip,
                    ),
                  ),
                ),
              ...
              child: Row(
                children: [
                  ...
                  InkWell(
                    ...
                    onTapDown: (details) {
                      setState(() {
                        acceptButton = Offset(0, 0);
                      });
                    },
                    onTapUp: (details) {
                      setState(() {
                        acceptButton = Offset(3, 3);
                      });
                    },
                    onTap: () {
                      ...
                      showModalBottomSheet(
                        ...
                        builder: (context) {
                          return _CarSelectionSheet(
                            cars: Provider.of<CarDetailsController>(
                              context,
                              listen: true,
                            ).listedVechiles, // pass your car list
                            onAssign: (selectedCar) {
                              Provider.of<DriverRideController>(
                                context,
                                listen: false,
                              ).acceptRide(
                                context,
            ...
            children: [
              ...
              GestureDetector(
                onTap: selectedCar == null
                    ? null
                    : () => widget.onAssign(selectedCar['_id']),
                child: AnimatedContainer(
                  duration: const Duration(milliseconds: 200),
                  width: double.infinity,
