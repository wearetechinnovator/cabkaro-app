...
class OngoingRidesScreen extends StatefulWidget {
  const OngoingRidesScreen({super.key});

  @override
  State<OngoingRidesScreen> createState() => _OngoingRidesScreenState();
}

class _OngoingRidesScreenState extends State<OngoingRidesScreen> {
              ...
              children: [
                ...
                CircleAvatar(
                  ...
                  child: const Icon(Icons.person,
                      color: Color(0xFFDDA200), size: 24),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: Column(
